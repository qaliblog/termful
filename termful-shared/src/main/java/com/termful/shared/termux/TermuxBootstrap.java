...
import com.termful.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxBootstrap {
    ...
    /** Is {@link PackageManager#APK} set as {@link #TERMUX_APP_PACKAGE_MANAGER}. */
    public static boolean isAppPackageManagerAPK() {
        return PackageManager.APK.equals(TERMUX_APP_PACKAGE_MANAGER);
    }
    ...
    /** Is {@link PackageVariant#ALPINE_ANDROID_7} set as {@link #TERMUX_APP_PACKAGE_VARIANT}. */
    public static boolean isAppPackageVariantAlpineAndroid7() {
        return PackageVariant.ALPINE_ANDROID_7.equals(TERMUX_APP_PACKAGE_VARIANT);
    }
    ...
    public enum PackageManager {
        ...
        /**
         * Alpine Package Keeper (APK) for managing Alpine Linux apk package files.
    ...
    public enum PackageVariant {
        ...
        /** {@link PackageManager#APK} variant for Android 7+. */
        ALPINE_ANDROID_7("apk-android-7");
