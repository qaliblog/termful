...
import com.termful.shared.activity.ActivityUtils;
import com.termful.shared.activity.media.AppCompatActivityUtils;
...
import com.termful.app.terminal.io.TerminalToolbarViewPager;
import com.termful.app.terminal.TermuxTerminalViewClient;
import com.termful.shared.termux.extrakeys.ExtraKeysView;
import com.termful.shared.termux.interact.TextInputDialogUtils;
...
import com.termful.shared.termux.theme.TermuxThemeUtils;
import com.termful.shared.theme.NightMode;
import com.termful.shared.view.ViewUtils;
...
import com.termful.view.TerminalViewClient;
...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
                ...
                if(PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.termful.shared.R.string.msg_storage_permission_granted_on_request));

                    TermuxInstaller.setupStorageSymlinks(TermuxActivity.this);
                } else {
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.termful.shared.R.string.msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
    ...
    private void registerTermuxActivityBroadcastReceiver() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(mTermuxActivityBroadcastReceiver, intentFilter, android.content.Context.RECEIVER_NOT_EXPORTED);
        } else {
