...
import com.termful.app.event.SystemEventReceiver;
import com.termful.app.terminal.TermuxTerminalSessionActivityClient;
import com.termful.app.terminal.TermuxTerminalSessionServiceClient;
import com.termful.shared.termux.plugins.TermuxPluginUtils;
import com.termful.shared.data.IntentUtils;
import com.termful.shared.net.uri.UriUtils;
import com.termful.shared.errors.Errno;
import com.termful.shared.shell.ShellUtils;
import com.termful.shared.shell.command.runner.app.AppShell;
import com.termful.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.termful.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.termful.shared.termux.shell.TermuxShellUtils;
...
import com.termful.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.termful.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.termful.shared.termux.shell.TermuxShellManager;
...
import com.termful.shared.notification.NotificationUtils;
import com.termful.shared.android.PermissionUtils;
import com.termful.shared.data.DataUtils;
import com.termful.shared.shell.command.ExecutionCommand;
import com.termful.shared.shell.command.ExecutionCommand.Runner;
import com.termful.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.termful.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.termful.shared.R.string.error_execution_cancelled))) {
