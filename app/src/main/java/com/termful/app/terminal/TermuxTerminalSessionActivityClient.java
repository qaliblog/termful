...
import com.termful.shared.termux.terminal.io.BellHandler;
import com.termful.shared.logger.Logger;
import com.termful.terminal.TerminalColors;
import com.termful.terminal.TerminalSession;
import com.termful.terminal.TerminalSessionClient;
import com.termful.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.termux/com.termful.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
